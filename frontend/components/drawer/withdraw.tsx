...
export function WithDrawDialog({ getUser }: { getUser: () => void }) {
    ...
    async function withdraw(e: React.FormEvent<HTMLFormElement>) {
        ...
        await axios.post(SERVER + "/api/v1/users/withdraw", payload, { withCredentials: true })
            .then((res) => {
                setErrmsg("Withdrawl successful")
                getUser()
                setLoading(false)
            })
            .catch((err) => {
            ...
            <DrawerContent>
                <div className="mx-auto w-full max-w-sm">
                    <DrawerHeader>
                        ...
                        <DrawerDescription>Get your money out from your account</DrawerDescription>
                    </DrawerHeader>
                    ...
                    <DrawerFooter>
                        <form onSubmit={async (e) => await withdraw(e)}>
                            ...
                            <Button className="w-full mt-3" type="submit">Withdraw</Button>
                        </form>
                        <DrawerClose asChild>
